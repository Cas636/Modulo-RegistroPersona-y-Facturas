...
/* Created on:     12/11/2023 1:00:43 p.�m.                     */
/*==============================================================*/
...
create table DIRECCION (
   ...
   IDTOPODOC            VARCHAR(2)           not null,
   NDOCUMENTO           VARCHAR(12)          not null,
   DIR_IDDIRECCION      NUMERIC(3)           null,
   POSICION             NUMERIC(2)           not null,
...
create table NOMENCLATURA (
   ...
   constraint PK_NOMENCLATURA primary key (POSICION, IDNOMEN)
);
...
alter table DIRECCION
   add constraint FK_DIRECCIO_DIRECCION_DIRECCIO foreign key (DIR_IDDIRECCION)
      references DIRECCION (IDDIRECCION)
      on delete restrict on update restrict;

alter table DIRECCION
   add constraint FK_DIRECCIO_NOMENCLAT_NOMENCLA foreign key (POSICION, IDNOMEN)
      references NOMENCLATURA (POSICION, IDNOMEN)
      on delete restrict on update restrict;
